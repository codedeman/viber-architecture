...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="ViberDemo",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC9ViberDemo11AppDelegate")
...
SWIFT_CLASS("_TtC9ViberDemo10NoticeCell")
...
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified brief;
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified file_source;
- (void)awakeFromNib;
...
SWIFT_CLASS("_TtC9ViberDemo20NoticeViewController")
...
@interface NoticeViewController (SWIFT_EXTENSION(ViberDemo)) <UITableViewDataSource, UITableViewDelegate>
...
SWIFT_CLASS("_TtC9ViberDemo13SceneDelegate")
...
SWIFT_CLASS("_TtC9ViberDemo13TableViewCell")
...
SWIFT_CLASS("_TtC9ViberDemo14ViewController")
